						...
						<div class="col-md-9">
							...
							<div class="card-body">
								<div class="d-flex justify-content-between">
									...
									<p class="card-text fw-bold price">{{cart.price |
										currency:'₫'}}</p>
								</div>
				...
				<div class="card border-0">
					<div class="card-body">
						...
						<p class="d-flex justify-content-between">
							<span class="fw-medium">Subtotal</span> <span class="fw-medium"
								id="subtotal" ng-model="subtotal">{{subtotal |
								currency:'₫'}}</span>
						</p>
						<p class="d-flex justify-content-between">
							<span class="fw-medium">Discount</span> <span class="fw-medium"
								id="discount" ng-model="discount">{{discount |
								currency:'₫'}}</span>
						</p>
						<hr>
