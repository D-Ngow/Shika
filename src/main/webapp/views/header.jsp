...
<body>
	<nav
		class="navbar navbar-expand-lg bg-white sticky-top border border-bottom-1">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="dropdown-menu border border-0 rounded-0 bg-light"
							...
							<c:forEach var="cate" items="${listcate}">
								<li><a class="dropdown-item"
									href="/product?cateId=${cate.categorieId}">${cate.name}</a></li>
							</c:forEach>
						</ul></li>
				...
				<div class="d-flex align-items-center gap-5">
					...
					<div class="dropdown-center d-flex alignment-item-center">
						<button type="button"
							class="dropdown-toggle border-0 bg-white bg-light"
						...
						<ul class="dropdown-menu">
							...
							<c:if test="${userdt == null}">
								<li><a class="dropdown-item d-flex align-items-center" href="/signup">
							...
							<c:if test="${userdt != null}">
								<li><a class="dropdown-item" href="/buyhistory"> <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#000000" d="M75 75L41 41C25.9 25.9 0 36.6 0 57.9L0 168c0 13.3 10.7 24 24 24l110.1 0c21.4 0 32.1-25.9 17-41l-30.8-30.8C155 85.5 203 64 256 64c106 0 192 86 192 192s-86 192-192 192c-40.8 0-78.6-12.7-109.7-34.4c-14.5-10.1-34.4-6.6-44.6 7.9s-6.6 34.4 7.9 44.6C151.2 495 201.7 512 256 512c141.4 0 256-114.6 256-256S397.4 0 256 0C185.3 0 121.3 28.7 75 75zm181 53c-13.3 0-24 10.7-24 24l0 104c0 6.4 2.5 12.5 7 17l72 72c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-65-65 0-94.1c0-13.3-10.7-24-24-24z"/></svg>
										<span class="ms-2">Buy History</span>
								</a></li>
							</c:if>
							<c:if test="${userdt != null}">
								<li><a class="dropdown-item" href="/changePass"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#000000" d="M336 352c97.2 0 176-78.8 176-176S433.2 0 336 0S160 78.8 160 176c0 18.7 2.9 36.8 8.3 53.7L7 391c-4.5 4.5-7 10.6-7 17l0 80c0 13.3 10.7 24 24 24l80 0c13.3 0 24-10.7 24-24l0-40 40 0c13.3 0 24-10.7 24-24l0-40 40 0c6.4 0 12.5-2.5 17-7l33.3-33.3c16.9 5.4 35 8.3 53.7 8.3zM376 96a40 40 0 1 1 0 80 40 40 0 1 1 0-80z"/></svg>
