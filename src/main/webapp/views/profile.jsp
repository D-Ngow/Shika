                        ...
                        <ul class="nav flex-column w-100 fw-bold">
                            <li class="nav-item flex-fill bg-light rounded-3 mb-2">
                                <a class="nav-link text-black d-flex align-items-center" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="me-2" height="14" width="12.25"
                                        viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                        <path fill="#000000"
                            ...
                            <li class="nav-item flex-fill rounded-3 mb-2">
                                <a class="nav-link text-black d-flex align-items-center" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="me-2" height="14" width="10.5"
                    ...
                    <div class="row">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-floating col-md-6">
                                        ...
                                        <label for="gender" class="ms-2 ps-3">Giới tính</label>
                                    </div>
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="overflow-auto">
                                <div class="card my-2">
                                    <div class="card-body d-flex justify-content-between align-items-center my-1">
                                        <div>
                                            <p class="mb-0">15 ABC, Đường XYZ, Phường 1, Quận 1, Thành phố Hồ Chí Minh,
                                                Việt Nam</p>
                                        </div>
                                        <div class="d-flex">
                                            ...
                                            <button class="btn btn-danger">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16.25"
                                                    viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                                    <path fill="#ffffff"
